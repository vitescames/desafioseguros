...
class GetAllInsuranceProductQueryHandlerTest {
    ...
    void handle_test() {
        ...
        List<GetInsuranceProductQueryResponse> response = getAllInsuranceProductQueryHandler.handle(new GetAllInsuranceProductQuery());
